---
description: >
  Use when creating interactive prototypes, HTML slide decks, motion graphics,
  GIF or MP4 animations, or infographics; when presenting design directions or
  comparing design variations; when the user wants to visualize ideas without
  writing production code. Do NOT use for standard component or page development
  — use ui-new for that.
---

<!-- Source: github.com/alchaincyf/huashu-design (MIT) -->
