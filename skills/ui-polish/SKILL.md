---
description: >
  Use when reviewing, auditing, critiquing, polishing, or improving existing UI;
  checking a component for design issues; iterating on styling quality. Also runs
  automatically as the second step of the ui-new pipeline after generating new UI.
  Commands: audit, polish, critique, shape, craft, animate, harden, and 16 more.
---
